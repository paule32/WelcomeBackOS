...
jmp  near entry_point                       ; jump to bootloader entry point
...
msgCRLF        db 13, 10, 0
msgProgress    db "*", 0
msgLoading     db "Loading second boot loader ...", 13, 10, 0
msgFailure     db 13, 10, "BOOT2.SYS MISSING", 13, 10, 0
 
TIMES 510-($-$$) db 56                       ; fill bytes until boot signature
